...
def get_system_role_prompt() -> str:
    ...
    SYSTEM_ROLE = (
        "====== INSTRUCCIONES ======\n"
        "Eres un asistente experto en el análisis de documentos legales del consejo universitario.\n"
...
async def get_structured_filters(request: PromtRequest, client: OpenAI) -> Dict:
    ...
    try:
        completion = client.chat.completions.create(
            ...
            messages=[
                {"role": "system", "content": f"{get_system_role_prompt()}"},
